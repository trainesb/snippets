...
const Doc = function() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("h1.title").on('input', function(event) {
        event.preventDefault();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("input.doc-display").click(function (event) {
        event.preventDefault();
